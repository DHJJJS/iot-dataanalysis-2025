...
<!-- 머신러닝과 딥러닝의 차이점이 뭐지? -->
<!-- 머신러닝은 사람이 "특징"을 설계하고 학습시킴 / 딥러닝은 특징도 스스로 추출하는 계층 구조 사용 (신경망 기반) -->
...
```
<!-- mlvenv가 뭐지? -->
<!-- mlvenv는 "가상환경" 이름. 이 환경 안에서만 패키지 설치/실행됨 (프로젝트별 분리 목적) -->
...
```
<!-- '가상환경'이라는 게 애초에 뭐지? 어떻게 적용되는 거지? -->
<!-- 다른 프로젝트와 패키지 충돌 없이 실행하게 도와주는 "독립된 파이썬 실행 공간" -->
...
```
<!-- 맷플롯립은 그래프였던가? -->
<!-- 기본 그래프 그리는 라이브러리 (선형 그래프, 막대 그래프 등) -->
...
```
<!-- 시본은 그래프였던 거 같은데. -->
<!-- 맷플롯립보다 더 예쁘고 쉽게 시각화 가능한 그래프 라이브러리 -->
...
```
<!-- 사이킷런이 뭐지? -->
<!-- 머신러닝 라이브러리. 분류, 회귀, 군집 등 ML 모델 학습 도구 모음 -->
...
```
<!-- 텐서플로가 뭐지? -->
<!-- 딥러닝용 프레임워크. 인공신경망을 구축하고 훈련시킬 수 있음 -->
...
<!-- 이진 분류가 뭐지? -->
<!-- 두 개의 클래스로 분류하는 문제 (예: 도미 or 빙어, 스팸 or 일반메일) -->
...
<!-- 둘 다 감이 안 옴... -->
<!-- 지도: "정답을 보여주는 학습" / 비지도: "정답 없이 패턴만 스스로 찾음" / 강화: "행동에 보상 줘서 학습" -->
